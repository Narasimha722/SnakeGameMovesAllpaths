...
public:
    ...
    void DrawGrid()
    {
        ...
        for (int i = 0; i <= cellCount; i++)
        {
            ...
            DrawLine(x, offset, x, offset + cellCount * cellSize, darkGreen);
        }
        ...
        for (int i = 0; i <= cellCount; i++)
        {
            ...
            DrawLine(offset, y, offset + cellCount * cellSize, y, darkGreen);
        }
    }
...
int main()
{
    ...
    InitWindow(2 * offset + cellSize * cellCount, 2 * offset + cellSize * cellCount, "Indian Cobra");
    SetTargetFPS(60);
    ...
    while (WindowShouldClose() == false)
    {
        ...
        DrawText("IndianCobra, Can Move All Paths", offset - 5, 20, 40, darkRed);
